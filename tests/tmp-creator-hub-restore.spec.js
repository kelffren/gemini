...
test('restored Creator Hub exposes full UI and hands off to World',async({page})=>{
  ...
  console.log('[HUB_RESTORE_IMPORT]',JSON.stringify(imported));
  expect(imported.hasOpen).toBe(true);
  ...
  console.log('[HUB_RESTORE_RESULT]',JSON.stringify(result));
  expect(result.studioActive).toBe(true);
