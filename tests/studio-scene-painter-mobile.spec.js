 ...
 * purpose: open the real World Studio mobile boot, wait for the optional Paint Copies wave, exercise Scene Painter UI + Grid batch + Undo, and stress shell DOM mutations without reviving the historical global MutationObserver storm
 * do-not: does not claim physical iPhone/Safari verification; BrowserStack/device evidence remains a separate BUG-0003 gate
 */
