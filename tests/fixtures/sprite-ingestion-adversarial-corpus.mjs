...
function specs() {
  ...
  return F([
    ...
    {id:'extreme-tight-spacing',tier:'EXTREME',label:'Sprites too close',background:'transparent',stepX:64,expectedFrames:16,expectedDirections:4,expectedStatus:'REVIEW_REQUIRED'},
    {id:'extreme-slight-overlap',tier:'EXTREME',label:'Small overlaps',background:'transparent',stepX:54,expectedFrames:16,expectedDirections:4,expectedStatus:'REVIEW_REQUIRED'},
    ...
    {id:'extreme-connected-bridge',tier:'EXTREME',label:'Two frames joined by a thin bridge',background:'transparent',bridge:[0,1],expectedFrames:16,expectedDirections:4,expectedStatus:'REVIEW_REQUIRED'},
