...
test('GOOD baseline opens, places, closes, walks, and reopens World editor', async ({ page }) => {
  ...
  // mapEditor=1 can legitimately auto-open Kelo Creators before every internal
  // launcher flag settles. Follow the visible player surface instead of waiting
  // on an implementation detail that is not required for interaction.
