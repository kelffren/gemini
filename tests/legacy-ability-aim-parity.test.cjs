...
assert.equal(aim.powerFromButtonDistance(36),0.5);
...
assert.equal(aim.measuredRange('dash',0),170*0.32);
assert.equal(aim.measuredRange('dash',1),170);
assert.equal(aim.measuredRange('fireball',0),300*0.45);
assert.equal(aim.measuredRange('frostnova',1),230);
assert.equal(aim.measuredRange('meteor',0.5),260*(0.4+0.6*0.5));
assert.equal(aim.measuredRange('unknown',0),160*0.4);
assert.equal(aim.measuredRange('unknown',1),160);
...
assert.equal(aim.measuredRange('dash',p0),170*(0.32+0.68*0.28));
assert.equal(aim.measuredRange('dash',pHalf),170*(0.32+0.68*0.5));
