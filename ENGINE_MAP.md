...
<!-- ENGINE-WORLD-BUILDER-V1:START -->
# WORLD BUILDER / LLAVE ADMIN V1 — OWNERSHIP
...
**Migración online:** `LocalWorldBuilderAuthority → ServerWorldBuilderAuthority`; después `Draft → Review → Publish`, con `world.publish` reservado para autoridad superior.

Ver `docs/WORLD_BUILDER_MEMORY.md`.
<!-- ENGINE-WORLD-BUILDER-V1:END -->
