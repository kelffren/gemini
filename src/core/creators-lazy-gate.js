...
const VERSION='kelo-creators-lazy-gate-v1';
let loading=null;
...
function loadStudio(){
  ...
  loading=new Promise(function(resolve,reject){
    const s=document.createElement('script');s.src='src/ui/studio-launcher.js?v=world-bridge-20260915-22';s.async=false;s.dataset.keloCreatorsFirstUse='1';
