 ...
 * do-not: NO inventory/economy authority, NO combat/PvP restore, NO continuous position writer
 */
(function(root){
  'use strict';
  ...
  function emit(name,detail){try{root.dispatchEvent(new CustomEvent('kelo:continuity:'+name,{detail:Object.assign(getState(),detail||{})}));}catch(_){} }
