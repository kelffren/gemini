...
const VERSION='kelo-feature-registry-v2.4.0-guardian-pvp-takeover';
const raw={
  ...
  pvp:{dependencies:['guardian'],policy:'first-use',files:[
    ...
    {src:'src/systems/pvp/shared-pvp-authority.js?v=1',name:'core autoridad PvP compartido'},
    {src:'src/systems/guardian-pvp-host.js?v=2-takeover',name:'Guardian PvP host temporal'},
