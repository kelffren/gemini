...
export const MAP_FORGE_GENERATOR_VERSION='1.5.0';
...
function candidateComparator(a,b){return Number(b.quality.rankingTotal??b.quality.total)-Number(a.quality.rankingTotal??a.quality.total)||visualTieScore(b)-visualTieScore(a)||String(a.metadata.layoutHash).localeCompare(String(b.metadata.layoutHash));}
