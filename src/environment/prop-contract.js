(function(){
  ...
  window.KELO_PROP_CONTRACT=Object.freeze({version:'1.3.0',mode:'generic-prop-contract-v3',assets,layerGroups,props:Object.freeze(defs),sources,getByDistrict(district){return defs.filter(p=>p.district===district);}});
})();
