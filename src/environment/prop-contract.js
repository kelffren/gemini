(function(){
  ...
  if(plazaNatureAtlas&&Array.isArray(R.plazaNatureProps)){
    for(const p of R.plazaNatureProps){
      defs.push(Object.freeze({
        ...
        size:Object.freeze({w:p.w,h:p.h}),
        ...
        ownership:'plaza-nature-props-v1',
        layers:Object.freeze({back:'props_back',front:'props_front'}),
        priority:10,
        district:'central',
        occlusion:Object.freeze({mode:'actor-base-y-clip-v1',baseY:p.baseY,clipPadding:8}),
        visualOnly:true
      }));
    }
  }
  const assets=Object.freeze({
    plazaNature:Object.freeze({
      id:'plazaNature',src:plazaNatureAtlas?.src,width:plazaNatureAtlas?.width,height:plazaNatureAtlas?.height,
  ...
  window.KELO_PROP_CONTRACT=Object.freeze({
    version:'1.0.0',mode:'generic-prop-contract-v1',assets,props:Object.freeze(defs),
