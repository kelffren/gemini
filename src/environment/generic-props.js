(function(){
  ...
  const audit=window.KELO_GENERIC_PROP_AUDIT={version:'generic-props-v1.2',contractVersion:C.version,ready:false,failed:false,propCount:C.props.length,assetCount:Object.keys(C.assets).length,layerGroupCount:groups.length,stackedLayerGroupCount:stackedGroups.length,immediateLayerGroupCount:groups.length-stackedGroups.length,rendererMode:'data-driven-props-v2',immediateDrawCalls:0,immediatePropCount:0};
  ...
  window.KELO_GENERIC_PROPS=Object.freeze({version:'generic-props-v1.2',drawInstances,isAssetReady(id){return readyAssets.has(id);},get ready(){return audit.ready&&!audit.failed;}});
