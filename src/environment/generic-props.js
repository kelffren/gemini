(function(){
  ...
  window.KELO_GENERIC_PROPS=Object.freeze({version:'generic-props-v1.4',drawInstances,isAssetReady(id){return readyAssets.has(id);},get ready(){return audit.ready&&!audit.failed;}});
