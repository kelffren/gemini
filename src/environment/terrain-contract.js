(function(){
  ...
  const districtVisualProfiles=Object.freeze({
    ...
    gardens:defineDistrict({id:'gardens',name:'Jardines del Sur',kind:'garden',bounds:{x:1056,y:2144,w:896,h:704},terrainProfile:'gardens',groundFamilies:['grass','marble'],transitionFamilies:['marble_to_grass'],pathFamilies:['marble'],vegetationFamilies:['gardens'],propFamilies:['gardens'],architectureFamilies:[],landmarkFamilies:['gardensFountain'],palette:'lush-cyan-garden',density:'high',variation:'clustered',decorationRules:{landmarkClearance:true,negativeSpace:'controlled'},placementRules:{promenadeClear:true,fountainFootprintClear:true}})
  });
  ...
  const districtApi=Object.freeze({version:'1.1.0',mode:'data-driven-district-visual-profiles-v2',profiles:districtVisualProfiles,order:districtOrder,districts,get:districtVisualProfileFor,terrainProfileFor:(id)=>districtVisualProfileFor(id)?.terrainProfile||id||'default',districtForPoint});
  window.KELO_DISTRICT_VISUAL_PROFILES=districtApi;
  window.KELO_TERRAIN_CONTRACT=Object.freeze({version:'1.4.0',tileSize:32,topology:'edge-bitmask-4-v1',defaults:Object.freeze({baseTerrain:'grass',pathTerrain:'marble'}),sideBits:SIDES,materials,transitions,profiles,districtVisualProfiles,districtOrder,districts,districtVisualProfileVersion:districtApi.version,requiredAtlasKeys,getTransition,frameFor,profileFor,districtVisualProfileFor,districtForPoint,collectAtlasKeys});
})();