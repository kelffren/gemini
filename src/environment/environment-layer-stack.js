...
syncAudit(true);
if(!window.__KELO_WORLD_ENVIRONMENT_SYNC_BOOT__){window.__KELO_WORLD_ENVIRONMENT_SYNC_BOOT__=import(new URL('src/environment/environment-world-sync.mjs?v=1',document.baseURI).href).catch(error=>{console.warn('[Kelo environment layers] world environment sync unavailable',error);return null;});}
})();