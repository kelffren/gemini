...
const C=Object.freeze([
  ...
  Object.freeze({id:'north-east-hedge-run',cells:Object.freeze([[16,4,'HEDGE_CAP_L'],[17,4,'HEDGE_H'],[18,4,'HEDGE_CAP_R']])}),
  Object.freeze({id:'south-west-hedge-run',cells:Object.freeze([[7,17,'HEDGE_CAP_L'],[8,17,'HEDGE_H'],[9,17,'HEDGE_CAP_R']])}),
  Object.freeze({id:'south-east-hedge-run',cells:Object.freeze([[15,17,'HEDGE_CAP_L'],[16,17,'HEDGE_H'],[17,17,'HEDGE_H'],[18,17,'HEDGE_CAP_R']])}),
  ...
  Object.freeze({id:'flowerbed-se',cells:Object.freeze([[17,14,'FLOWER_CAP_L'],[18,14,'FLOWERBED'],[19,14,'FLOWER_CAP_R']])})
]);
const styles=Object.freeze({
  ...R.styles,
  gardensCompositions:Object.freeze({
    mode:'registry-authored-garden-compositions-v2',
    sourceAtlas:G.id,
    joinAtlas:J.id,
...
window.KELO_GARDENS_COMPOSITION_AUDIT=Object.freeze({version:'gardens-compositions-v2',ready:true,mode:styles.gardensCompositions.mode,compositionCount:C.length,joinAtlas:J.id,joinMode:J.mode});
})();
