...
const T_JUNCTION_ATLAS=Object.freeze({
  id:'gardens-t-junctions-v1',src:'assets/gardens-t-junctions-v1.svg?v=1',width:128,height:32,tileWidth:32,tileHeight:32,columns:4,
...
const styles=Object.freeze({...R.styles,gardensCompositions:Object.freeze({
  mode:'registry-authored-garden-compositions-v19',sourceAtlas:G.id,joinAtlas:J.id,tJunctionAtlas:T_JUNCTION_ATLAS,
  centerVariationMode:'authored-mid-variant-selection-v2',verticalVariationMode:'mirrored-authored-vertical-mid-v1',
  junctionMode:'authored-four-orientation-t-family-v6',tJunctionOwnership:'registry-overlay-exclusive-v1',legacyVirtualTJunctions:false,
...
window.KELO_GARDENS_COMPOSITION_AUDIT=Object.freeze({
  version:'gardens-compositions-v19',auditRevision:'exclusive-t-ownership-v1',ready:true,mode:styles.gardensCompositions.mode,
  ...
  tJunctionOrientationCount:4,altCenterTileCount:4,verticalAltUsageCount:3,navigationConflictFixCount:16,connectedJunctionCount:4,tJunctionCount:2,
