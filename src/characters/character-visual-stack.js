...
(function (root) {
  ...
  const VERSION = 'character-visual-stack-v1.0.0';
  ...
  function resolve(options) {
    ...
    if (!A) return [];
    const o = options || {};
    const face = normalizeFace(o.face || (o.actor && (o.actor._face || o.actor._visualMotion && o.actor._visualMotion.face)) || 'down');
    const state = stateFor(A, o.actor || null, o.state || null);
    const order = A.faceOrder && A.faceOrder[face] || A.slots || [];
