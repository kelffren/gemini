...
export function installCreatorAvatarRuntime({root=globalThis}={}){
  ...
  const api=Object.freeze({version:'kelo-creator-avatar-runtime-v2.1.0-community-self',register,select,current,get:id=>records.get(String(id))||null,list:()=>[...records.values()],clear(){selectedId=null;selectedManifest=null;persist(null);dispatchSelfCommunity(null);},get selectedId(){return selectedId;}});
  ...
  root.KELO_CREATOR_AVATAR_AUDIT=Object.freeze({version:api.version,owner:'KeloAvatar middleware',priority:900,localRestore:true,communitySelfStream:true,middlewareId});
  return api;
}
