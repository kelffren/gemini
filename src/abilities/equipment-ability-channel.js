...
const VERSION='equipment-ability-channel-v1.1.0',COUNT=3,LABELS=Object.freeze(['Q','W','E']),listeners=new Map(),slots=Array(COUNT).fill(null);let fingerprint='none',weaponId=null,profileId=null,profileName=null,weaponFamily=null,abilityKeys=[],selectionStatus='none',customized=false;
...
root.KELO_EQUIPMENT_ABILITY_AUDIT=Object.freeze({version:VERSION,slotCount:COUNT,stoneStateWrites:0,equipmentStateWrites:0,reusesKeloAbilitiesEngine:true,duplicateDeliveryHandlers:0,simulationHooks:0,mountMutualExclusion:true,dataDrivenProfiles:true,perItemSlotChoices:true});
