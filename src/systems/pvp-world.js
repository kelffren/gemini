/* KELO-INDEX
 * area: PVP / WORLD
 * owner: KeloPvPWorld; frame/simulation extension owners KeloRender + KeloSimulation
 * keys: PVP ARENA TRANSITION SWAP SWORD RENDER INTERCEPT SIMULATION FOUNDATION
 * purpose: conserva autoridad/comandos PvP y usa extensiones Foundation para arena exclusiva y tick
 * public-api: KeloPvPWorld, enterPvPWorld, leavePvPWorld
 * consumes: KeloRender, KeloSimulation, KeloMeleeEngine, KeloCombatEngine, KeloAbilities
 * state-owned: modo PvP, transición, target, cooldown básico, floats y swap sword local prototype
 * extension-points: KeloRender.intercept/afterFrame + KeloSimulation.after
 ...
 * do-not: NO envolver render/updateSimulation
 */
(function(){
'use strict';
const VERSION='pvp-world-v1.9-foundation',TRANSITION_MS=1150,WORLD=Object.freeze({x:2660,y:360,w:720,h:720,spawnX:2790,spawnY:720,dummyX:3190,dummyY:720});
