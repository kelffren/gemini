...
(function(root){
  'use strict';
  const VERSION='melee-weapon-profiles-v3.5.1-light-active-mobility-ab';
  ...
  register({
    ...
    movementScale:{windup:.86,active:.55,recovery:1},knockback:15,stagger:.07,
  ...
  register({
    ...
    movementScale:{windup:.76,active:.34,recovery:.76},knockback:34,stagger:.13,
  ...
  register({
    ...
    movementScale:{windup:.58,active:.25,recovery:.64},knockback:46,stagger:.18,
