...
export const KeloCommunityLibraryTab=Object.freeze({version:'community-library-tab-v5',refresh,get state(){return Object.freeze({loaded:state.loaded,loading:state.loading,assets:state.assets.length,equipped:state.equipped.length});}});
