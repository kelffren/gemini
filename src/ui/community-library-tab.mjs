 ...
 */
import './external-library-browser-ui.mjs?v=3';
import {
  listCommunityAssets,
...
export const KeloCommunityLibraryTab=Object.freeze({version:'community-library-tab-v3',refresh,get state(){return Object.freeze({loaded:state.loaded,loading:state.loading,assets:state.assets.length,equipped:state.equipped.length});}});
