...
@media(max-height:620px){#kelo-chat-drawer{height:50dvh;min-height:0}.kc-keyboard{height:min(154px,25dvh);min-height:0}.kc-head{padding-top:4px;padding-bottom:4px}.kc-feed{padding-top:5px;padding-bottom:5px}.kc-compose{padding-top:5px;padding-bottom:5px}}
@media(orientation:landscape){#kelo-chat-drawer{left:max(10px,calc(env(safe-area-inset-left) + 6px));right:max(10px,calc(env(safe-area-inset-right) + 6px));height:50dvh;min-height:0}.kc-keyboard{height:min(142px,28dvh);min-height:0}.kc-tab{height:44px}#kelo-chat-drawer{--kc-peek:44px}.kc-title{font-size:15px}.kc-message{margin-bottom:5px}.kc-bubble{padding:6px 8px;font-size:12px}.kc-composer,.kc-send{min-height:38px;height:38px}.kc-send{width:38px}.kc-compose{grid-template-columns:minmax(0,1fr) 38px}}
