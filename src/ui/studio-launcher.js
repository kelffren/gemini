...
(function(){
  ...
  const CREATOR_BUILD='world-chrome-20260914-1';
  ...
  const api=Object.freeze({version:'studio-launcher-v1.15.0-world-chrome',open,openSpriteFactory:openFactory,sync,get allowed(){return allowed();},get directRequested(){return directRequested();}});
