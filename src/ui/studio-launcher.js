...
(function(){
  ...
  const CREATOR_BUILD='direct-creators-recovery-20260913-1';
  ...
  const api=Object.freeze({version:'studio-launcher-v1.11.0-direct-creators',open,openSpriteFactory:openFactory,sync,get allowed(){return allowed();},get directRequested(){return directRequested();}});
