 ...
 * purpose: añade CREATORS al menú Luxe existente y carga Creator Hub solo bajo acción explícita
...
(function(){
  ...
  async function open(){
    ...
    try{
      ...
      console.error('[Kelo Creators launcher]',e);toast(e?.message||'No se pudo abrir Kelo Creators');
  ...
  const api=Object.freeze({version:'studio-launcher-v1.2.0',open,sync,get allowed(){return allowed();}});
