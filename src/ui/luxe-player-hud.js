...
.kw-hud-top{position:relative;display:grid;grid-template-columns:62px minmax(0,1fr);gap:8px;align-items:start}.kw-hud-left{display:grid;gap:5px}.kw-hud-avatar{position:relative;width:62px;height:62px;border-radius:15px;border:2px solid #d8b656;background:#07141a;overflow:hidden;box-shadow:0 5px 14px rgba(0,0,0,.34),0 0 12px rgba(231,197,106,.12);pointer-events:auto}.kw-hud-avatar-img{position:absolute;inset:0;background-repeat:no-repeat;background-position:0 0;background-size:cover}.kw-hud-avatar-img.sprite{background-size:400% 400%;background-position:0 0}.kw-hud-avatar:after{content:"◆";position:absolute;left:50%;bottom:-6px;transform:translateX(-50%) rotate(45deg);font:7px Georgia,serif;color:#f3d57e;background:#0a1c23;padding:1px 3px}
...
.kw-hud-identity{min-width:0}.kw-hud-name-row{display:flex;align-items:flex-start;gap:5px}.kw-hud-name{min-width:0;flex:1;color:#fff3cb;font:800 clamp(13px,4vw,18px)/1.05 Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 0 12px rgba(231,197,106,.14)}.kw-hud-id-row{display:flex;align-items:center;gap:4px;margin-top:3px;color:#9eaea9;font-size:7px;letter-spacing:.05em}.kw-hud-copy{width:26px;height:26px;margin:-7px 0 -7px auto;border:1px solid rgba(231,197,106,.28);border-radius:8px;background:rgba(9,25,30,.88);color:#e7c56a;pointer-events:auto;font-size:11px}.kw-hud-copy:active,.kw-hud-avatar:active{transform:scale(.96)}
.kw-hud-prestige{display:grid;grid-template-columns:minmax(0,1.4fr) minmax(72px,.8fr);gap:5px;margin-top:6px}.kw-hud-nobility{position:relative;min-height:47px;padding:6px 7px 6px 41px;border:1px solid rgba(238,202,101,.88);border-radius:11px;background:radial-gradient(circle at 18% 45%,rgba(232,186,66,.22),transparent 35%),linear-gradient(145deg,rgba(38,47,32,.82),rgba(7,23,28,.94));box-shadow:0 0 15px rgba(231,197,106,.16),inset 0 0 0 1px rgba(255,231,160,.06)}.kw-hud-crown{position:absolute;left:7px;top:50%;transform:translateY(-52%);font:28px/1 Georgia,serif;color:#f3cd62;text-shadow:0 0 10px rgba(243,205,98,.42)}.kw-hud-nobility small,.kw-hud-title small{display:block;color:#e3c86f;font:700 6px Georgia,serif;text-transform:uppercase;letter-spacing:.1em}.kw-hud-nobility strong{display:block;margin-top:1px;color:#fff1b8;font:900 17px/1 Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 0 11px rgba(231,197,106,.24)}.kw-hud-title{min-width:0;padding:7px 7px;border:1px solid rgba(231,197,106,.38);border-radius:11px;background:rgba(6,20,26,.78);display:flex;flex-direction:column;justify-content:center}.kw-hud-title strong{display:block;margin-top:2px;color:#f5e6bd;font:800 11px/1.05 Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
@media(max-width:360px){#kw-player-hud-wrap{width:calc(100vw - 78px - max(16px,env(safe-area-inset-left)))}.kw-player-hud{padding:6px;border-radius:15px}.kw-hud-top{grid-template-columns:54px minmax(0,1fr);gap:6px}.kw-hud-avatar{width:54px;height:54px;border-radius:13px}.kw-hud-clan{padding:3px;grid-template-columns:15px minmax(0,1fr)}.kw-hud-clan-icon{width:15px;height:18px}.kw-hud-clan-copy b{font-size:7px}.kw-hud-prestige{gap:4px}.kw-hud-nobility{min-height:43px;padding-left:35px}.kw-hud-crown{left:5px;font-size:24px}.kw-hud-nobility strong{font-size:14px}.kw-hud-title{padding:5px}.kw-hud-title strong{font-size:9px}.kw-hud-resources{gap:4px;margin-top:5px}.kw-hud-resource{grid-template-columns:22px minmax(0,1fr);gap:5px}.kw-hud-resource-icon{width:22px;height:22px;font-size:11px}.kw-hud-gold{height:27px;margin-top:5px}.kw-hud-gold-value{font-size:13px}}
...
byId('kw-hud-copy')?.addEventListener('click',async()=>{const id=snapshot().id;try{await navigator.clipboard.writeText(id);if(typeof root.showToast==='function')root.showToast('ID copiado');}catch(e){if(typeof root.showToast==='function')root.showToast('ID: '+id);}});
byId('kw-hud-avatar')?.addEventListener('click',()=>{const p=player();if(typeof root.inspectPlayer==='function'&&p)root.inspectPlayer(p,true);});
