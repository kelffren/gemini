...
style.textContent=`
#kw-player-hud-wrap{position:absolute;top:max(7px,env(safe-area-inset-top));left:max(7px,env(safe-area-inset-left));width:clamp(208px,56vw,224px);pointer-events:none;z-index:86;color:#fff4d6;font-family:-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif}
.kw-player-hud{position:relative;overflow:hidden;padding:5px;border:1px solid rgba(231,197,106,.7);border-radius:13px;background:radial-gradient(circle at 54% 12%,rgba(42,82,77,.2),transparent 36%),linear-gradient(145deg,rgba(7,28,36,.97),rgba(5,16,23,.99) 70%);box-shadow:0 8px 22px rgba(0,0,0,.34),inset 0 0 0 1px rgba(255,255,255,.025),inset 0 0 18px rgba(15,73,78,.09)}
.kw-player-hud:before{content:"";position:absolute;inset:3px;border:1px solid rgba(231,197,106,.11);border-radius:10px;pointer-events:none}.kw-player-hud:after{content:"◆";position:absolute;bottom:-4px;left:50%;transform:translateX(-50%) rotate(45deg);color:#e7c56a;font:6px Georgia,serif;text-shadow:0 0 6px rgba(231,197,106,.46)}
.kw-hud-top{position:relative;display:grid;grid-template-columns:44px minmax(0,1fr);gap:5px;align-items:start}.kw-hud-left{display:grid;gap:3px}.kw-hud-avatar{position:relative;width:44px;height:44px;padding:0;border-radius:10px;border:1.5px solid #d8b656;background:#07141a;overflow:hidden;box-shadow:0 3px 9px rgba(0,0,0,.3),0 0 8px rgba(231,197,106,.1);pointer-events:auto}.kw-hud-avatar-img{position:absolute;inset:0;background-repeat:no-repeat;background-position:0 0;background-size:cover}.kw-hud-avatar-img.sprite{background-size:400% 400%;background-position:0 0}.kw-hud-avatar:after{content:"◆";position:absolute;left:50%;bottom:-5px;transform:translateX(-50%) rotate(45deg);font:5px Georgia,serif;color:#f3d57e;background:#0a1c23;padding:1px 2px}
.kw-hud-clan{min-height:25px;padding:3px;border-radius:7px;border:1px solid rgba(231,197,106,.3);background:rgba(4,16,22,.7);display:grid;grid-template-columns:13px minmax(0,1fr);gap:3px;align-items:center}.kw-hud-clan-icon{width:13px;height:16px;display:grid;place-items:center;border:1px solid rgba(231,197,106,.5);border-radius:4px 4px 6px 6px;color:#e9c968;font:8px Georgia,serif}.kw-hud-clan-copy{min-width:0;line-height:1}.kw-hud-clan-copy small{display:block;color:#8fa39e;font-size:5px;text-transform:uppercase;letter-spacing:.05em}.kw-hud-clan-copy b{display:block;margin-top:2px;color:#f1dfaa;font:700 7.2px Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.kw-hud-identity{position:relative;min-width:0}.kw-hud-name-row{display:flex;align-items:flex-start;gap:3px}.kw-hud-name{min-width:0;flex:1;padding-right:24px;color:#fff3cb;font:800 clamp(11px,3.5vw,13.5px)/1.03 Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 0 9px rgba(231,197,106,.12)}.kw-hud-id-row{display:flex;align-items:center;min-height:9px;margin-top:1px;color:#9eaea9;font-size:6px;letter-spacing:.035em;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}.kw-hud-copy{position:absolute;top:-10px;right:-4px;width:44px;height:44px;border:0;background:transparent;color:#e7c56a;pointer-events:auto;font-size:10px;opacity:.86}.kw-hud-copy:before{content:"";position:absolute;inset:12px;border:1px solid rgba(231,197,106,.28);border-radius:5px;background:rgba(9,25,30,.46)}.kw-hud-copy{isolation:isolate}.kw-hud-copy::after{content:"⧉";position:absolute;inset:0;display:grid;place-items:center;z-index:1}.kw-hud-copy{font-size:0}.kw-hud-copy:active,.kw-hud-avatar:active{transform:scale(.96)}.kw-hud-copy:focus-visible,.kw-hud-avatar:focus-visible,.kw-guide:focus-visible{outline:2px solid #f4d77f;outline-offset:2px}
.kw-hud-prestige{display:grid;grid-template-columns:minmax(0,1.45fr) minmax(52px,.72fr);gap:3px;margin-top:3px}.kw-hud-nobility{position:relative;min-height:34px;padding:4px 4px 4px 27px;border:1px solid rgba(238,202,101,.88);border-radius:8px;background:radial-gradient(circle at 16% 45%,rgba(232,186,66,.2),transparent 35%),linear-gradient(145deg,rgba(34,43,30,.82),rgba(7,23,28,.94));box-shadow:0 0 11px rgba(231,197,106,.16),inset 0 0 0 1px rgba(255,231,160,.06)}.kw-hud-crown{position:absolute;left:5px;top:50%;transform:translateY(-52%);font:19px/1 Georgia,serif;color:#f3cd62;text-shadow:0 0 8px rgba(243,205,98,.42)}.kw-hud-nobility small,.kw-hud-title small{display:block;color:#e3c86f;font:700 5px Georgia,serif;text-transform:uppercase;letter-spacing:.07em}.kw-hud-nobility strong{display:block;margin-top:1px;color:#fff1b8;font:900 10.5px/1 Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;text-shadow:0 0 9px rgba(231,197,106,.24)}.kw-hud-title{min-width:0;padding:4px;border:1px solid rgba(231,197,106,.34);border-radius:8px;background:rgba(6,20,26,.76);display:flex;flex-direction:column;justify-content:center}.kw-hud-title strong{display:block;margin-top:2px;color:#f5e6bd;font:800 7.8px/1.02 Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.kw-hud-resources{display:grid;gap:3px;margin-top:3px}.kw-hud-resource{display:grid;grid-template-columns:18px minmax(0,1fr);gap:4px;align-items:center}.kw-hud-resource-icon{width:18px;height:18px;border-radius:50%;display:grid;place-items:center;border:1px solid rgba(231,197,106,.42);background:#07151a;font-size:9px;box-shadow:inset 0 0 0 1px rgba(255,255,255,.025)}.kw-hud-resource-main{min-width:0}.kw-hud-resource-head{display:flex;justify-content:space-between;gap:4px;align-items:baseline;color:#d9e2dc;font-size:6px;line-height:1}.kw-hud-resource-head b{color:#f4e7bf;font:800 7px Georgia,serif}.kw-hud-bar{height:5px;margin-top:2px;border-radius:99px;overflow:hidden;border:1px solid rgba(231,197,106,.34);background:#061116;box-shadow:inset 0 1px 2px rgba(0,0,0,.65)}.kw-hud-bar i{display:block;height:100%;width:0;transition:width .2s ease}.kw-hud-hp i{background:linear-gradient(90deg,#a81216,#f04436);box-shadow:0 0 6px rgba(239,68,54,.26)}.kw-hud-mana i{background:linear-gradient(90deg,#0759b8,#21a5ff);box-shadow:0 0 6px rgba(33,165,255,.23)}.kw-hud-resource.unavailable{opacity:.58}.kw-hud-resource.unavailable .kw-hud-bar i{width:0!important}
.kw-hud-gold{margin-top:4px;height:22px;padding:0 7px;border-radius:8px;border:1px solid rgba(231,197,106,.4);background:linear-gradient(90deg,rgba(9,26,30,.9),rgba(5,17,23,.92));display:flex;align-items:center;gap:5px}.kw-hud-gem{width:9px;height:9px;transform:rotate(45deg);background:linear-gradient(135deg,#ffe59a,#c48e27);box-shadow:0 0 6px rgba(231,197,106,.25)}.kw-hud-gold-label{color:#e8d391;font:800 8px Georgia,serif}.kw-hud-gold-value{margin-left:auto;color:#fff0bd;font:900 11.5px Georgia,serif}
.kw-guide{pointer-events:auto;display:inline-flex;align-items:center;justify-content:center;gap:4px;min-height:44px;margin-top:4px;padding:0 10px;border-radius:9px;border:1px solid rgba(231,197,106,.48);background:linear-gradient(145deg,rgba(13,34,37,.95),rgba(5,16,21,.97));box-shadow:0 5px 14px rgba(0,0,0,.25),inset 0 0 0 1px rgba(255,255,255,.025);color:#edcf76;text-decoration:none;font:850 8px Georgia,serif;letter-spacing:.07em}.kw-guide:active{transform:scale(.97)}
@media(max-width:360px){#kw-player-hud-wrap{width:208px}.kw-player-hud{padding:5px}.kw-hud-name{font-size:11.5px}.kw-hud-nobility strong{font-size:10px}.kw-hud-title strong{font-size:7.3px}.kw-hud-clan-copy b{font-size:6.8px}}
@media(max-height:520px) and (orientation:landscape){#kw-player-hud-wrap{width:214px}.kw-player-hud{padding:4px}.kw-hud-top{grid-template-columns:40px minmax(0,1fr);gap:4px}.kw-hud-avatar{width:40px;height:40px}.kw-hud-clan{min-height:23px}.kw-hud-prestige{margin-top:2px}.kw-hud-resources{gap:2px;margin-top:2px}.kw-hud-resource{grid-template-columns:17px minmax(0,1fr);gap:3px}.kw-hud-resource-icon{width:17px;height:17px}.kw-hud-gold{height:21px;margin-top:3px}.kw-guide{margin-top:3px}}
`;
