...
.kw-hud-clan{min-height:23px;padding:2px 3px;border-radius:7px;border:1px solid rgba(231,197,106,.3);background:rgba(4,16,22,.72);display:grid;grid-template-columns:13px minmax(0,1fr);gap:3px;align-items:center}.kw-hud-clan-icon{width:13px;height:16px;display:grid;place-items:center;border:1px solid rgba(231,197,106,.5);border-radius:4px 4px 6px 6px;color:#e9c968;font:8px Georgia,serif}.kw-hud-clan-copy{min-width:0;line-height:1}.kw-hud-clan-copy small{display:block;color:#8fa39e;font-size:5px;text-transform:uppercase;letter-spacing:.06em}.kw-hud-clan-copy b{display:block;margin-top:1px;color:#f1dfaa;font:700 7px Georgia,serif;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.kw-guide{position:relative;pointer-events:auto;display:inline-flex;align-items:center;justify-content:center;gap:4px;min-height:30px;margin-top:4px;padding:0 9px;border-radius:9px;border:1px solid rgba(231,197,106,.5);background:linear-gradient(145deg,rgba(13,34,37,.97),rgba(5,16,21,.98));box-shadow:0 5px 13px rgba(0,0,0,.25),inset 0 0 0 1px rgba(255,255,255,.03);color:#edcf76;text-decoration:none;font:850 8px Georgia,serif;letter-spacing:.07em}.kw-guide:before{content:"";position:absolute;inset:-7px}.kw-guide:active{transform:scale(.97)}
@media(max-width:360px){#kw-player-hud-wrap{width:clamp(180px,55vw,198px)}.kw-player-hud{padding:4px;border-radius:11px}.kw-hud-top{grid-template-columns:42px minmax(0,1fr);gap:4px}.kw-hud-avatar{width:42px;height:42px;border-radius:9px}.kw-hud-clan{min-height:21px}.kw-hud-prestige{gap:2px}.kw-hud-nobility{min-height:31px;padding-left:22px}.kw-hud-crown{font-size:16px}.kw-hud-nobility strong{font-size:10px}.kw-hud-title strong{font-size:7px}.kw-hud-resource{grid-template-columns:16px minmax(0,1fr);gap:3px}.kw-hud-resource-icon{width:16px;height:16px;font-size:8px}.kw-hud-gold{height:21px}.kw-hud-gold-value{font-size:11px}}
@media(max-height:520px) and (orientation:landscape){#kw-player-hud-wrap{width:204px;top:max(4px,env(safe-area-inset-top));left:max(4px,env(safe-area-inset-left))}.kw-hud-clan{display:none}.kw-hud-left{display:block}.kw-hud-top{grid-template-columns:40px minmax(0,1fr)}.kw-hud-avatar{width:40px;height:40px}.kw-hud-prestige{margin-top:2px}.kw-hud-resources{gap:2px;margin-top:3px}.kw-hud-gold{height:20px;margin-top:3px}.kw-guide{min-height:28px;margin-top:3px}}
`;
