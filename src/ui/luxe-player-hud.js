...
@media(max-width:360px){#kw-player-hud-wrap{width:clamp(180px,55vw,198px)}.kw-player-hud{padding:4px;border-radius:11px}.kw-hud-top{grid-template-columns:42px minmax(0,1fr);gap:4px}.kw-hud-avatar{width:42px;height:42px;border-radius:9px}.kw-hud-clan{min-height:21px;padding-left:11px}.kw-hud-clan-icon{width:8px;height:13px;font-size:5.5px}.kw-hud-clan-copy b{font-size:6.2px}.kw-hud-prestige{gap:2px}.kw-hud-nobility{min-height:31px;padding-left:22px}.kw-hud-crown{font-size:16px}.kw-hud-nobility strong{font-size:10px}.kw-hud-title strong{font-size:7px}.kw-hud-resource{grid-template-columns:16px minmax(0,1fr);gap:3px}.kw-hud-resource-icon{width:16px;height:16px;font-size:8px}.kw-hud-gold{height:21px}.kw-hud-gold-value{font-size:11px}}
