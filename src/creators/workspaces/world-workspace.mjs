...
export function createWorldWorkspaceManifest({loader=()=>import(`../../studio/integration/live-studio-controller.mjs?v=${WORLD_BUILD}`),mapForgeImporter=()=>import('../../studio/adapters/map-forge-draft-importer.mjs')}={}){
