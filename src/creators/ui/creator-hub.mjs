...
const CATALOG=Object.freeze([
  ...
  {category:'GAMEPLAY',items:[['mount','Mount','active'],['ability','Ability','active'],['npc','NPC','soon'],['quest','Quest / Dialogue','soon'],['item','Item','soon'],['crafting','Crafting','soon']]},
...
const REPOSITORY_PROJECT_TYPES=Object.freeze({animation:'ANIMATION',vfx:'VFX',ability:'ABILITY'});
const PROJECT_LABELS=Object.freeze({ANIMATION:'Animation',VFX:'VFX',ABILITY:'Ability'});
function css(){return `
...
export async function openCreatorHub({root=globalThis}={}){
  ...
  active=Object.freeze({version:'kelo-creator-hub-v1.7.0',hub,platform,get section(){return current;},show:render,close:destroy});await render('create');return active;
}
