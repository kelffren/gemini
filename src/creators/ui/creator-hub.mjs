...
export async function openCreatorHub({root=globalThis}={}){
  ...
  active=Object.freeze({version:'kelo-creator-hub-v1.6.0',hub,platform,get section(){return current;},show:render,close:destroy});await render('create');return active;
}
