 ...
 */
import { bootKeloCreators } from '../creator-entry.mjs?v=world-editor-20260925-1';
...
function css(){return `
[data-kelo-creators-ui]{box-sizing:border-box;font-family:Inter,ui-sans-serif,system-ui,-apple-system,BlinkMacSystemFont,sans-serif;color:#f5f3ea}
...
export async function openCreatorHub({root=globalThis}={}){
  ...
  const style=make('style',{textContent:css()});
