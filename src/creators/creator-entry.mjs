 ...
 * does-not-own: Studio core, World/Animation implementation, gameplay or network transport
 */
...
export async function bootKeloCreators({root=globalThis,stateAdapter=null}={}){
  ...
  registerWorldWorkspace(workspaces);registerAnimationWorkspace(workspaces);
  ...
  platform=Object.freeze({version:'kelo-creators-core-v1.1.0',permission,projects,workspaces,dependencies,openWorkspace,close(){try{localState.close?.();}catch{}platform=null;}});
  return platform;
}
