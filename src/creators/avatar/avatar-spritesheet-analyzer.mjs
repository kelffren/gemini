...
function inferGrid(width,height){const ratio=width/height;if(width>=512&&height>=512&&ratio>0.92&&ratio<1.08)return{columns:4,rows:4,confidence:'high'};if(width>=384&&height>=384&&ratio>0.75&&ratio<1.34)return{columns:4,rows:4,confidence:'medium'};return{columns:1,rows:1,confidence:'low'};}
