 ...
 * keys: AVATAR UNIVERSAL SPRITE INGESTION HYPOTHESES FOREGROUND NORMALIZE VALIDATE 1D 4D 8D REVIEW
 ...
 * consumes: Sprite Compiler foreground/layout/rig/normalizer/validator + staged Avatar V4 fallback
