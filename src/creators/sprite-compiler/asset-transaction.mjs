...
export function createAssetTransaction({id='asset-transaction'}={}){
 ...
 const read=key=>staged.get(String(key));
 ...
 return F({stage,read,gate,commit,rollback,get state(){return state;},snapshot(){return F({id,state,keys:F([...staged.keys()]),gates:F([...gates])});}});
}
