...
const BIOMES=new Set(['plaza','forest','swamp','desert','snow','coast']);
...
const GROUND=Object.freeze({
  plaza:'#242631',forest:'#14261f',swamp:'#1a2925',desert:'#8d6036',snow:'#cbd5dc',coast:'#5f704f'
});
...
export function createEnvironmentPreviewModel(draft={}){
  ...
  const primaryColor=intent.palette[0]||'';
  return Object.freeze({
    biome,weather,timeOfDay,ambientDensity,musicMood,intent,featureCount,particleCount,
    sky:SKY[timeOfDay],ground:GROUND[biome],accent:ACCENTS[primaryColor]||'rgba(215,182,107,.12)',
