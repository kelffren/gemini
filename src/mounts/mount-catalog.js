...
const VERSION='mount-catalog-v1.0.0',SCHEMA_VERSION=1;
...
registerMovement({id:'movement.horse.standard',acceleration:520,maxSpeed:255,braking:680,turnRate:8.5,momentum:.62});
registerMovement({id:'movement.wolf.fast',acceleration:720,maxSpeed:275,braking:760,turnRate:10.5,momentum:.4});
