/* KELO-INDEX
 * area: SERVER
 * keys: WEBSOCKET AUTHORITY VISUAL EVENT RELAY CAST PROJECTILE STATUS VALIDATION TITLES PROGRESSION
...
console.log(`Kelo plaza room on ws://0.0.0.0:${PORT} · Nobleza ${nobility.source} · Titles ${titles.source} · Forge ${forge.source}`);
...
wss.on('connection', (ws) => {
  ...
  players.set(id, me);
  send(ws, { t: 'welcome', id, players: publicState(), nobilitySource: nobility.source, titleSource: titles.source, forgeSource: forge.source });
