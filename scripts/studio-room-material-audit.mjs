...
console.log(JSON.stringify({ok:true,phase:'7.3',tool:'ROOM material',wallStyle:true,floorStyle:true,roomIsolation:true,openingVisualPreserved:true,restoreTracksNewWallStyle:true,wallHistoryEntries:1,floorHistoryEntries:1,oneUndo:true,oneRedo:true,authorityCommands:['room.material.wall','room.material.floor']},null,2));
