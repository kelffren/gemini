...
const fetchPriority = (anyHas(sourceFiles, "priority:'high'") || anyHas(sourceFiles, "priority: 'high'") || anyHas(sourceFiles, 'priority: "high"'))
  && (anyHas(sourceFiles, "priority:'low'") || anyHas(sourceFiles, "priority: 'low'") || anyHas(sourceFiles, 'priority: "low"'));
