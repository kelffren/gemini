...
const expected = process.env.EXPECTED_BUILD || 'V5.51';
const expectedRegistry = process.env.EXPECTED_REGISTRY || '1.8.0';
const expectedLandmarks = process.env.EXPECTED_LANDMARKS || 'rural-landmarks-v1.1';
...
const ruralFrame=await page.evaluate(()=>{
  ...
  // Frame the authored farmstead cluster on a mobile viewport without clipping either landmark.
