...
if(!source.includes("world-workspace.mjs?v=world-bridge-20260914-13"))fail('World workspace cache-bust is behind the live bridge build');

console.log(JSON.stringify({ok:true,file,lazySpriteAbilityImports:spriteImports.length,worldBootExcluded:true,workspaceBuild:'world-bridge-20260914-13'}));
