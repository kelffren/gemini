...
ok('analyzer infers 4x4 square sheets',analyzer.includes('width===height')&&analyzer.includes('columns:4,rows:4'));
ok('analyzer can remove uniform light background',analyzer.includes('removeBackground')&&analyzer.includes('putImageData'));
