...
const migrated=['engine-m.js','engine-o.js','engine-p.js','engine-q.js','engine-s.js','engine-net.js','src/systems/pvp-world.js','src/abilities/sword-swap-runtime.js','src/visuals/sword-swap-pvp-visuals.js','src/ui/pvp-social-touch-guard.js'];
const trace=[];
...
function directSimulationAssignment(text){return /\b(?:window\.|globalThis\.|root\.)?updateSimulation\s*=/.test(text);}
