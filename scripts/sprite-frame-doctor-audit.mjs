...
console.log(JSON.stringify({ok:true,total:diagnosis.total,defective:diagnosis.defective.map(x=>({index:x.index,label:x.label,reasons:x.reasons})),selectiveTargets:targets.map(x=>x.index),healthyPixelsPreserved:true}));
