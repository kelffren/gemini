...
for(const seed of seeds){
  ...
  assert.ok(score.breakdown.decorationSpacing<=65,`${seed}: 90px local crowding must expose severe visual spacing defect, got ${score.breakdown.decorationSpacing}`);
