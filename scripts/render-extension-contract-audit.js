...
ok(abilities.includes("KeloRender.afterFrame('kelo-ability-boot:legacy-fx'")&&abilities.includes('}, 1000);'),'ABILITY_RENDER_OWNER_HOOK');
...
console.log('RENDER_EXTENSION_OK: single bridge + exclusive intercept + deterministic hooks + removed legacy Canvas monkey-patch guard passed');
