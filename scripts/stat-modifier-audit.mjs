...
assert.equal(Stats.version,'stat-modifier-v1.1.0');
...
console.log(JSON.stringify({ok:true,owner:'KeloStatModifiers',version:Stats.version,deterministic:true,scopeWhileMounted:true,mountTarget:true,exactReversion:true,progressStatsSeparated:true},null,2));
